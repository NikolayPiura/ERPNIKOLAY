(function(){
  ...
  const art={
    ...
    climate:'<ellipse cx="110" cy="177" rx="79" ry="11" fill="currentColor" opacity=".08"/><path d="M40 70l121-18 26 15-122 20Z" fill="url(#G)" stroke="#d3fff4" stroke-opacity=".7"/><path d="M40 70v87l25 22V87Z" fill="url(#D)" stroke="currentColor" stroke-opacity=".6"/><path d="M65 87l122-20v90L65 179Z" fill="url(#D)" stroke="currentColor" stroke-opacity=".7"/><path d="M82 63V44q0-8 8-9l43-7q8-1 8 7v20l-14 2V43l-31 5v13Z" fill="url(#G)" stroke="currentColor" stroke-opacity=".65"/><path d="M65 106l122-20v29L65 135Z" fill="url(#G)" opacity=".72"/><path d="M111 116l24-4v24l-24 4Z" fill="url(#G)" stroke="#e2fff7" stroke-opacity=".5"/><path d="M77 157l29-5M144 146l29-5" stroke="currentColor" opacity=".35"/>',
