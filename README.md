...
Фонд PFF, фонд Москва, SAFE, Solid, доходы, личный доход, «Ментор», FP и инвестиционный PFF вынесены в отдельный репозиторий `ERP-Finance-Nikolay`. В этой ERP остаются «Утро», «Эффективность», «ПС №1», «Админ-шкала», структура фондов, благотворительные «Фонды» и «Друг».
